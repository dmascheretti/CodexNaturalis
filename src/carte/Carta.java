...
public abstract class Carta {
	...
	/** This method prints a card
	 * @return the card with its resources
	 */
	...
	/**This method prints the front of a card
	 * @return the front of the card with its resources
	 */
	...
	/**This method checks the coordinates of the game table in order to place a card
	 * @param tabellone game table
	 * @param x rows
	 * @param y columns
	 * @return
	 */
	...
	/** This method sets the cards' points
	 */
